// Package gpu turns on gg's GPU tier for figure's raster backend.
//
...
// figure changes — the same IR, the same marks, the same output — and nothing
// needs to be passed anywhere:
//
//	import (
//	    ggbackend "github.com/timzifer/figure/backend/gg"
//	    _ "github.com/timzifer/figure/backend/gg/gpu" // opt into the GPU tier
//	)
//
...
//
// [ADR 0006]: https://github.com/timzifer/figure/blob/main/docs/adr/0006-gg-coupling-surface.md
package gpu
