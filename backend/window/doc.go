// Package window draws figure charts in a native window.
//
...
// paid only when the frame changed: figure repaints nothing when a frame is
...
// # A separate module
//
// Like backend/gg, this is a nested module: importing figure's core still
