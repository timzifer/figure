...
// did not: a pie and a donut are a stacked [github.com/timzifer/figure/geom.Bar]
// with θ from the Y axis, a rose is the same bar with θ from an ordinal X, a
// radar is a [github.com/timzifer/figure/geom.Line] over one, and a gauge is a
...
// outer radius is that hole plus [github.com/timzifer/figure/geom.X2]: the
