...
// [github.com/timzifer/figure/scale.Nanos] converts one, and
// [github.com/timzifer/figure/scale.Time] maps that domain — so a time series
...
func NewStream(cols ...string) *Stream {
	if len(cols) == 0 {
		panic("figure/data: NewStream needs at least one column")
	}
	s := &Stream{
...
// [github.com/timzifer/figure/scale.Time] axis maps.
