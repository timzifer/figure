...
figure owns text *placement* and nothing else: shaping belongs to the active
...
**The `Measure` seam is the whole of figure's text problem.** It is the only
...
- gg hints glyph advances to whole pixels; figure's `hmtx` reader sums
