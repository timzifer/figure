...
### The parser is figure's, and it is small on purpose
...
figure uses, in a module whose whole positioning is that it has none.
...
What is testable about that path is figure's half of it: that the format is
