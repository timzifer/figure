...
// [github.com/timzifer/figure.Plot.Render] or Plot.Live through a recorder.
...
// figure's own work: with a real emitter most of a frame's time and memory
// belongs to the emitter, and a gate on figure's allocations would be reading
// someone else's.
