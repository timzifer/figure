...
// answers is the four questions [github.com/timzifer/figure/backend/pdf] has
...
var ErrFormat = errors.New("figure/internal/sfnt: unsupported font file")
...
// bargain [github.com/timzifer/figure/data.Float64Columns] makes about a
