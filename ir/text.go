...
// FontRef names a font logically. figure never carries glyph data or font
...
//
// figure passes strings, never pre-shaped glyphs: shaping belongs to the
// active backend. figure owns only placement — anchoring, rotation, and
...
//
// Measure is the only text capability figure requires beyond drawing: layout
