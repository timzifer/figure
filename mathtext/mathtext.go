...
// # Pluggable
//
// [Typesetter] is the seam. figure calls it with a label and gets back the
...
// the same bargain the rest of figure's text handling makes (docs/adr/0003).
//
...
// everything else in figure uses. Placing that origin — anchoring, alignment,
